...
gem 'coffee-rails', '5.0.0', require: false # CoffeeScript Javascript preproc
gem 'fastly-rails', '0.8.0'
gem 'font-awesome-rails', '4.7.0.8'
gem 'imagesLoaded_rails', '4.1.0' # JavaScript - enable wait for image load
gem 'jbuilder', '2.7.0'
gem 'jquery-rails', '4.3.2' # JavaScript jQuery library (for Rails)
...
gem 'rails', '7.0.8.1' # Our web framework
...
group :development do
  ...
  gem 'web-console', '3.6.0' # Debugging tool for Ruby on Rails apps
end

group :test do
  gem 'capybara-slow_finder_errors', '0.1.5' # warn if test waits for timeout
