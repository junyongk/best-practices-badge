...
gem 'puma', '4.3.12' # Faster webserver; recommended by Heroku
gem 'rails', '6.1.7.3' # Our web framework
...
gem 'secure_headers', '3.9.0' # Add hardening measures to HTTP headers
